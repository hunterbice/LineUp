...
if (appVersion !== "v67") throw new Error(`APP_VERSION should be v67, found ${appVersion}`);
...
if (!/href="\/icons\/favicon-32\.png\?v=67"/.test(html)) throw new Error("favicon link should use the v67 LineUp icon asset");
if (!/href="\/icons\/apple-touch-icon\.png\?v=67"/.test(html)) throw new Error("apple-touch-icon link should use the v67 LineUp icon asset");
