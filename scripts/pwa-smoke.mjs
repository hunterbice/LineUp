...
if (appVersion !== "v68") throw new Error(`APP_VERSION should be v68, found ${appVersion}`);
...
if (!/href="\/icons\/favicon-32\.png\?v=68"/.test(html)) throw new Error("favicon link should use the v68 LineUp icon asset");
if (!/href="\/icons\/apple-touch-icon\.png\?v=68"/.test(html)) throw new Error("apple-touch-icon link should use the v68 LineUp icon asset");
