...
if (appVersion !== "v66") throw new Error(`APP_VERSION should be v66, found ${appVersion}`);
...
if (!/href="\/icons\/favicon-32\.png\?v=66"/.test(html)) throw new Error("favicon link should use the v66 LineUp icon asset");
if (!/href="\/icons\/apple-touch-icon\.png\?v=66"/.test(html)) throw new Error("apple-touch-icon link should use the v66 LineUp icon asset");
