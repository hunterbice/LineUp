...
export function mapboxToken() {
  return cacheState.getMapboxTokenOverride() ||
...
export function deviceSessionEnabled() {
  return cacheState.isDeviceSessionEnabled();
}
